...
<body class="bg-gray-100 p-8">
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        createAgency($bank_id, $name, $longitude, $latitude, $address_id);
    ...
    <div class="max-w-md mx-auto bg-white p-6 rounded-md shadow-md">
        <h2 class="text-2xl font-semibold text-gray-800 mb-4">Add Agency</h2>
        <form method="post" action="">
            ...
            <label for="name" class="block text-sm font-medium text-gray-700 mt-4">Agency Name</label>
            ...
            <button type="submit" class="mt-4 bg-blue-500 text-white p-2 rounded-md">Add Agency</button>
        </form>
    </div>
</body>
</html>
